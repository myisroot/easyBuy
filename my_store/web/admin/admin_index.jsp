...
scrolling：是否有滚动条
  -->
<%
    if (session.getAttribute("admin_user") == null || session.getAttribute("admin_user").equals("")) {
...
<frameset rows="70,*" frameborder=0 border="0" framespacing="0">
    ...
    <frameset cols="250,*" frameborder="0" border="0" framespacing="10">
        ...
        <frame src="${pageContext.request.contextPath}/admin_product?action=allProduct"
               name="mainFrame">
    </frameset>
</frameset>
</html>
