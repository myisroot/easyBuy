...
public class FileUpload {
     ...
     * bool 表示是否保存文件
     */
    public static Map<String, Object> fileUpload(HttpServletRequest req, String filePath, String bufferPath, Integer SizeThreshold, Integer FileSizeMax, List<String> list) throws UnsupportedEncodingException {
